...
// request comes in, at most once every 3600 seconds or 1 hour.
export const revalidate = 3600

// We'll prerender only the params from `generateStaticParams` at build time.
// If a request comes in for a path that hasn't been generated,
// Next.js will server-render the page on-demand.
// export const dynamicParams = true // true or false, false to 404 on unknown paths
...
export default async function Page({
  ...
  const blog = await fetch(
    `https://api.github.com/repos/youngbloodcyb/md-demo-content/contents/post/${slug}.md?ref=main`
  )
